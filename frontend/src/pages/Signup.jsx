    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="mb-6 rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-left text-xs text-amber-800">
            Hackathon tip: turn off <strong>Confirm email</strong> in Supabase
            (Authentication → Providers → Email) to skip this step entirely.
          </p>
          <Link
            to="/login"
