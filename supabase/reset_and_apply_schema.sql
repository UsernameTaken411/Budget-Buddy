-- One-time reset: drops the old (pre-SCHEMA.md) tables/views and rebuilds
-- everything from scratch using the current supabase/schema.sql. Only needed
-- once, on a project that already has the mismatched old structure
-- (transaction_date/transaction_type instead of date/signed amount).
--
-- This DELETES all existing rows in these tables. Fine for hackathon/dev
-- data — do not run this against anything with real user data.
...
-- ===========================================================================
-- Everything below is identical to supabase/schema.sql
-- ===========================================================================
